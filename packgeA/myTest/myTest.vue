<template>
	<view class="box">
		...
		<taskItem :list="dataList" :paddingTop="300" :current="3"></taskItem>

		<view style="height:95rpx;"></view>
		<view class="categoryBox flex">
			<view :class="{ active: forms.category === 1 }" @click="titleFrom(1)">客观题</view>
			<view :class="{ active: forms.category === 0 }" @click="titleFrom(0)">主观题</view>
