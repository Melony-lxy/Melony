	...
	<view class="box">
		<view class="headers" :style="{
			...
			<view class="headBox space-between u-f-ac">
				...
				<image class="setUp" @click="navigateTo('/packgeA/setUp/setUp')" :src="common.imgUrl('/static/my/shezhi.png')"
					mode=""></image>
			</view>
				...
				<view class="scroolTd">
					<view class="service-shop">
						<view v-for="(item, index) in serviceMall" :key="index" class="item "
							...
							<view class="itemList">
								<image :src="common.imgUrl(item.imgUrl)" mode="" :style="{ width: item.width, height: item.height }">
								</image>
