(global["webpackJsonp"] = global["webpackJsonp"] || []).push([["packgeA/common/vendor"],{

/***/ 262:
/*!*******************************************************************!*\
  !*** D:/Melony/千芒/duvclub.7mango.cn-vue/plugin/qqmap-wx-jssdk.js ***!
  \*******************************************************************/
...
var wx = {
  request: function request(obj) {
    ...
    vm.$jsonp(obj.url, obj.data).then(function (json) {
      if (json.status == 0) {
        obj.success(json);
      } else {
        obj.fail(json);
...
//# sourceMappingURL=../../../.sourcemap/mp-weixin/packgeA/common/vendor.js.map